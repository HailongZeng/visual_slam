...
def visualize_trajectory_2d(pose,map,path_name="Unknown",show_ori=False):
  '''
  ...
  Input:
      ...
      map:  2*m   m is the number of landmarks, map[0] is the coordinate x of map, map[1] is the coordinate y of map
  '''
  ...
  ax.scatter(map[0],map[1])  # added by myself, to plot map
